...
for t_idx = 1:length(target_timesI)
    ...
    % プロット (z = 0) caseI
    plot(r(:,1), Jt(:, 10), 'DisplayName', ['t=', num2str(target_time+399), 'us'], 'LineWidth', 3);
    hold on;
end
xlabel('r [m]', 'FontSize', 14);
...
% 図を保存
% saveFolder = "G:\My Drive\lab\lab_data\mach_probe\jt_profile";
% saveas(gcf, strcat(saveFolder, '\comparison_caseI_caseO', num2str(dateI), '_', num2str(dateO), '.png'), 'png');
